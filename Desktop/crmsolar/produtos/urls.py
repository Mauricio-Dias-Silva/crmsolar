...
urlpatterns = [
    ...
    path('rastrear-proposta/', views.rastreio_proposta, name='rastreio_proposta'),
    path('portfolio-completo/', views.portfolio_completo, name='portfolio_completo'),
    path('simular-financiamento/', views.simular_financiamento, name='simular_financiamento'),
    path('simulador-economia/', views.simulador_solar, name='simulador_solar'),
