...
class Produto(models.Model):
    ...
    garantia_anos_equipamento = models.IntegerField(default=1, verbose_name="Garantia Padrão (Anos)")
    
    TIPO_EQUIPAMENTO_CHOICES = [
        ('MODULO', 'Módulo Fotovoltaico'),
        ('INVERSOR', 'Inversor / Microinversor'),
        ('ESTRUTURA', 'Estrutura de Fixação'),
        ('ACESSORIO', 'Acessório / Cabo'),
    ]
    tipo_equipamento = models.CharField(max_length=20, choices=TIPO_EQUIPAMENTO_CHOICES, default='ACESSORIO')
